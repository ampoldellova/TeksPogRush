...
const startFlipping = () => {
  ...
  spinAnimationPog1(finalRotationPog1, rotationY1, () =>
    startSlowDown(finalRotationPog1, rotationY1),
  )
}
...
.flipPogsInner {
  ...
  /* transition: transform-style 0.6s linear; */
}
...
.flipPogsFront {
  background-image: url('../src/assets/pogs/tikbalang.png');
  background-size: cover;
  background-position: center;
}

.flipPogsBack {
  background-image: url('../src/assets/pogs/Tails.png');
  background-size: cover;
  background-position: center;
