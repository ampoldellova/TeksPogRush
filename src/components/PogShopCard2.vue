  ...
  >
    ...
    <el-row :style="bottomRowStyle">
      <el-col :span="18">
        <el-row>
          <el-col :span="24">
            <el-text :style="{ fontFamily: 'regular', color: 'white' }">002 | Bayanihan</el-text>
          </el-col>
          <el-col :span="24">
      ...
      <el-col :span="6">
        <el-row>
          <el-image :src="epic" :style="{ width: '45px', height: '45px' }" />
        </el-row>
      </el-col>
...
import epic from '@/assets/rarities/Epic.png'
...
const rowStyle = computed(() => ({
  ...
  background: isHovered.value
    ? 'linear-gradient(to bottom, #141414, rgba(133, 42, 28, 1)'
    : 'linear-gradient(to bottom, #141414, rgba(133, 42, 28, 0.5)',
